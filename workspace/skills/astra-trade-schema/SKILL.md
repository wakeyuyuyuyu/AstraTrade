...
4. 如果不确定通用字段，读取 `skills/astra-trade-schema/references/common.md`。

## Reference 选择规则

- `state/*.json` → 读取 `skills/astra-trade-schema/references/state.md`
- `pools/*.jsonl` → 读取 `skills/astra-trade-schema/references/pools.md`
- `logs/*.jsonl` → 读取 `skills/astra-trade-schema/references/logs.md`
- `reports/*.json` → 读取 `skills/astra-trade-schema/references/reports.md`
- `logs/agent_runs/*` → 读取 `skills/astra-trade-schema/references/reports.md`
- 通用枚举、时间格式、ID 规则、evidence 格式 → 读取 `skills/astra-trade-schema/references/common.md`
